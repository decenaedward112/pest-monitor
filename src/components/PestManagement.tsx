    ...
    <div className="w-8/12">
      <div className="bg-[#dee8c9] p-10 rounded-3xl grid gap-8">
        ...
        {cropStage === "Vegetative" && type === "deadhearts" && (
          <div>
            ...
            <p>
              ...
              not significantly impacted even if DH incidence were up to 31%.
              This is because crops in the vegetative stage compensate for the
              damage by producing more tillers.
            </p>
            <p>
              4. Pull out damaged shoots by hand: If it does not come out
              easily, it might be caused by other pests like the Rice Black Bug.
            </p>
          </div>
        )}
        ...
        {cropStage === "Vegetative" && type === "ysb" && (
          <div>
            <p>
              1. Make use of systemic pesticides like Chlorantranilipore 12.5%
              SC at 0.3 mL per liter of water (60mL per acre).
            </p>
            ...
            <p>
              ...
              like Quinalphos 25 EC (100 mL/ha), Phosphamidon 40 SL (600 mL/ha),
              or Profenophos 50 EC (1000 mL/ha). Newly hatched larvae require
              two applications of either Quinalphos or Phosphamidon at 1000
              mL/ha, spaced 7 days apart.
            </p>
          </div>
        )}
        ...
        {cropStage === "Reproductive" && type === "ysb" && (
          <div>
            ...
            <p>
              2. Implement intercropping by planting other crops alongside rice
              to confuse or deter the pest.
            </p>
          </div>
        )}
        ...
        {cropStage === "Reproductive" && type === "eggs" && (
          <div>
            <p>
              1. Manually remove and destroy egg masses from the leaf blades.
            </p>
          </div>
        )}
      </div>
